...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/autoflake-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6569&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/autoflake-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `autoflake` can be installed with:

```
conda install autoflake
```

It is possible to list all of the versions of `autoflake` available on your platform with:
